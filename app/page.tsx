...
export default async function Page() {
  const { games, news, statcast, fetchedAt, standings } = await getTodaysGames()

  return (
    <main className="min-h-screen bg-background">
      <SportsGuide games={games} news={news} statcast={statcast} fetchedAt={fetchedAt} standings={standings} />
    </main>
  )
}
